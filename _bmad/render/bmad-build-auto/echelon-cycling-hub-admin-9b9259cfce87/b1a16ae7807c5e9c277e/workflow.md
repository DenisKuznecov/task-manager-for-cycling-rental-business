...
1. **Folder+id dispatch** (`{spec_folder}` and `{story_id}` are set): the write-back always lands at the id-keyed story spec. The `/Users/denyskuznetsov/Documents/echelon-cycling-hub-admin/echelon-cycling-hub-admin/_bmad-output/implementation-artifacts` fallback in step 2 below is never used in this mode, even for halts before planning starts.
...
2. **Otherwise:**
   ...
   - If `{spec_file}` is unknown or missing, create `/Users/denyskuznetsov/Documents/echelon-cycling-hub-admin/echelon-cycling-hub-admin/_bmad-output/implementation-artifacts/bmad-build-auto-result-<slug-or-timestamp>.md` with:
     ```markdown
     ---
     status: <final status>
     ---
...
- Speak in `English`, tailor communication to `beginner`, and write documents in `English`.
...
Read fully and follow: `/Users/denyskuznetsov/Documents/echelon-cycling-hub-admin/echelon-cycling-hub-admin/_bmad/render/bmad-build-auto/echelon-cycling-hub-admin-9b9259cfce87/b1a16ae7807c5e9c277e/step-01-clarify-and-route.md`.
